    ...
    <div className=' w-full h-[30vh] md:h-[80vh] relative bg-[#EEF6F8]'>
    ...
    
        {
            currentItem ===1 ?(
                <div className=' flex flex-row justify-center items-center w-full h-full' >
                    <div className='w-[60%] h-full'>
                        ...
                        <div className=' ml-4 md:ml-20  w-[80%] md:w-[60%] flex flex-row justify-between text-sm md:text-2xl'>
                            <button className='w-[40%] md:pt-4 md:pb-4 bg-mainBg text-white  font-medium pt-1 pb-1 rounded-2xl'> <Link to="/aboutUs">About Us</Link></button>
                            <button className='w-[40%] bg-mainBg text-white font-medium pt-1 pb-1 rounded-2xl'> <Link to="/aboutUs">Find Doctor</Link></button>
                        </div>
                    </div> 
                ...
                <div className='w-[60%] h-full'>
                        <div className='p-4 md:p-20'>
                            <h1 className='mb-3 md:mb-10 text-2xl md:text-6xl font-bold tracking-wider text-red-600 '>Find Blood</h1>
                        ...
                        <div className=' ml-4 md:ml-20  w-[80%] md:w-[60%] flex flex-row justify-between text-sm md:text-2xl'>
                            <button className='w-[40%] pt-1 pb-1 md:pt-4 md:pb-4 bg-mainBg text-white  font-medium  rounded-2xl'> <Link to="/aboutUs">Find Blood</Link></button>
                            <button className='w-[50%] bg-mainBg text-white font-medium pt-1 pb-1 rounded-2xl'> <Link to="/aboutUs">Donate Blood</Link></button>
                        </div>
                </div> 

                <div className='w-[40%] h-full'>
                    <img src={blood} alt="" className='w-full h-full object-cover object-center' />
                </div>
                ...
                <div className=' flex flex-row justify-center items-center w-full h-full' >
                    <div className='w-[60%] h-full'>
                        ...
                        <div className=' ml-4 md:ml-20  w-[80%] md:w-[80%] flex flex-row justify-between text-xs md:text-2xl'>
                            <button className='w-[40%] rounded-2xl md:pt-4 md:pb-4 bg-mainBg text-white  font-medium pt-1 pb-1'> <Link to="/aboutUs">Find Ambulance</Link></button>
                            <button className='w-[50%] bg-mainBg text-white font-medium pt-1 pb-1 rounded-2xl'> <Link to="/aboutUs">Register Ambulance</Link></button>
                        </div>
                    </div> 

                    <div className='w-[40%] h-full'>
                        <img src={ambulance} alt="" className='w-full h-full object-fill object-center' />
                    </div>
